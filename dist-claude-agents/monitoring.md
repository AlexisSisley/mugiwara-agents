...
name: monitoring
description: >
  Use this agent when the user needs observability setup, alerting, dashboards, or SRE practices. Agent Monitoring et Alerting de l'ecosysteme Mugiwara.
  
  Examples:
  - Example 1:
    user: "Configure Prometheus et Grafana pour nos microservices"
    assistant: "Je vais mettre en place l'observabilite."
    <The assistant uses the Agent tool to launch the monitoring agent to set up Prometheus/Grafana monitoring stack with dashboards.>
  - Example 2:
    user: "Definis des SLI/SLO pour notre API de paiement"
    assistant: "Je vais definir les objectifs de fiabilite."
    <The assistant uses the Agent tool to launch the monitoring agent to define SLIs, SLOs, and alerting rules.>
