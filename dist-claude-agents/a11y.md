...
name: a11y
description: >
  Use this agent when the user wants a code quality review, tech debt audit, or architecture assessment. Agent Accessibilite (a11y) de l'ecosysteme Mugiwara.
  
  Examples:
  - Example 1:
    user: "Fais une code review du service de notification"
    assistant: "Je vais analyser la qualite du code."
    <The assistant uses the Agent tool to launch the a11y agent to perform a thorough code quality review of the notification service.>
  - Example 2:
    user: "Identifie la dette technique dans ce module"
    assistant: "Je vais auditer la dette technique."
    <The assistant uses the Agent tool to launch the a11y agent to audit the module for technical debt and anti-patterns.>
