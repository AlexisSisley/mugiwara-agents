...
name: merry
description: >
  Merry — Going Merry, pipeline de decouverte produit. Orchestre 2 phases :
...
Lance Vivi via l'outil Skill avec `skill: "vivi"` et `args: "$ARGUMENTS"` :
...
args: "$ARGUMENTS — Recherche produit de Vivi : [resume des personas cles, user flows prioritaires, features priorisees par RICE, contraintes marche et metriques cibles extraits de l'output de Vivi]"
