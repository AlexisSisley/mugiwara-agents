...
name: smoker
description: >
  Smoker — Chasseur de Tickets GLPI de l'ecosysteme Mugiwara. Recupere les
  tickets GLPI (incidents, demandes, changements), les trie par priorite et
  impact, et dispatche automatiquement vers les bons agents Mugiwara pour
  implementation. Peut aussi mettre a jour le statut des tickets et poster
  des comptes-rendus de resolution.
