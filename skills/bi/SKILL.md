...
name: bi
description: >
  Agent BI & Data Visualization de l'ecosysteme Mugiwara.
...
argument-hint: "[powerbi <report> | tableau <viz> | metabase <question> | superset <chart> | looker <explore> | dax <measure> | kpi <domain> | storytelling <data> | audit]"
...
Analyse les besoins en data visualization et propose des dashboards KPI
adaptes au contexte business avec les outils et visualisations optimaux.

**Arguments** : `$ARGUMENTS`

Modes supportes :
- `powerbi <report>` : conception de rapport Power BI avec DAX
- `tableau <viz>` : creation de visualisation Tableau
- `metabase <question>` : configuration Metabase (questions, dashboards)
- `superset <chart>` : configuration Apache Superset
- `looker <explore>` : modelisation LookML et explores
- `dax <measure>` : ecriture de mesures DAX avancees
- `kpi <domain>` : definition de KPIs pour un domaine metier
- `storytelling <data>` : structuration de data storytelling
- `audit` : audit BI complet (dashboards, modeles, performance)
