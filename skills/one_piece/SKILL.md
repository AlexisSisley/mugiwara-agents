...
Exemples :
- `Skill(skill: "ace", args: "Fais un load test sur l'API /orders avec k6")`
...
4. **Mixage libre** : un pipeline dynamique peut combiner :
   - Des subagents via `Agent` (chopper, franky, nami, jinbe, robin, zorro, sanji, luffy, brook, usopp, vivi)
...
| 3 | Scaffold nouveau code | sanji | [S] | sequentiel |
